...
public class Template extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String jsonString = "{\n" +
                ...
                "          \"layout_height\": \"530\",\n" +
                "          \"layout_marginTop\" : \"80\",\n" +
                "          \"layout_marginStart\" : \"120\",\n" +
                "          \"background\" : \"#e6e6e6\"\n" +
                "        },\n" +
                "        {\n" +
                "          \"layout_width\": \"670\",\n" +
                "          \"layout_height\": \"530\",\n" +
                "          \"layout_marginTop\" : \"230\",\n" +
                "          \"layout_marginStart\" : \"135\",\n" +
                "          \"background\" : \"#ffffff\"\n" +
                "        }\n" +
                "    ],\n" +
                "    \"Stickerview\" :  [{\n" +
    ...
    public void convert(String jsonString) throws JSONException {
        ...
        JSONArray jsonStickerArray = jsonObject.getJSONArray("Imageview");
    ...
    private void initializeParent(JSONObject parent) throws JSONException {
        ...
        if(parent.has("backgroundColor")) {
            String colorString = parent.getString("backgroundColor");
